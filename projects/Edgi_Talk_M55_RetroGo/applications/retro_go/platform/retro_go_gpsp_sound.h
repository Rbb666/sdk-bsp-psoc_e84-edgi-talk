/* PSoC build-time compatibility view of the upstream gpSP sound interface.
 * Issue #349 reduces GBA audio generation to 32 kHz. Keeping this outside the
 * snapshot preserves upstream integrity while selecting the same low-load
 * configuration for Cortex-M55. */
/* gameplaySP
 *
...
#ifndef BSP_RETRO_GO_GBA_AUDIO_MIX_KHZ
#define BSP_RETRO_GO_GBA_AUDIO_MIX_KHZ 16
#endif
#define GBA_SOUND_FREQUENCY   (BSP_RETRO_GO_GBA_AUDIO_MIX_KHZ * 1000)
